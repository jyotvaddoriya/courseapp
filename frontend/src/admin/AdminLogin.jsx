...
function AdminLogin() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (error.response) {
        setErrorMessage(error.response.data.error || "AdminLogin failed");
      }
    }
  };
      ...
      <div className="h-screen container mx-auto flex items-center justify-center text-white">
        <header className="absolute top-0 left-0 w-full flex justify-between items-center p-5">
          ...
          <div className="flex items-center space-x-4">
            <Link to={"/admin/signup"} className="bg-transparent border border-gray-500 p-1 text-sm md:text-md md:py-2 md:px-4 rounded-md">Signup</Link>
        ...
        <div className="bg-gray-900 p-8 rounded-lg shadow-lg w-[500px] m-8 md:m-0 mt-20">
          ...
          <p className="text-center text-gray-400 mb-6">Log in to access Admin Dashboard</p>
